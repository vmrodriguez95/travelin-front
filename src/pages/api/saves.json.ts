...
// server gave it — including the ones created in this same request. It
// must not carry an `id` matching a POI, since the cards remove themselves
// when a fetch answers with their own id.
const DATA = {
  idPoi: "177278946269aa9ed6b396a",
  collections: [
